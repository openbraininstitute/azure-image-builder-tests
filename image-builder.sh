...
export template_image_builder_id=/subscriptions/${subscription}/resourcegroups/${rg}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/${identity_name}
